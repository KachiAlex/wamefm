...
test.describe('Navigation & Pages', () => {
  test('home page loads with hero section', async ({ page }) => {
    ...
    await page.goto('/')
    await expect(page.getByText(/embassy\s*radio/i).first()).toBeVisible({ timeout: 20000 })
  ...
  test('about page loads', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: /about embassy radio/i })).toBeVisible()
  })
