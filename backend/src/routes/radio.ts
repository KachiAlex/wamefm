...
import { getRadioStatus, skipSermon, stopRadio, startRadio, initRadioScheduler } from '../sermon-stream.js'

const router = Router()

/* POST /radio/start — force-start a playlist immediately */
...
/* POST /radio/stop — force-stop the radio stream */
...
/* POST /radio/skip — skip to next sermon */
...
/* GET /radio/status — current radio state */
...
/* POST /radio/scheduler/restart — re-init the scheduler (admin) */
