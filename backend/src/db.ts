...
const SCHEMA_QUERIES = [
  ...
  `CREATE TABLE IF NOT EXISTS broadcasts (
    ...
    church_online_url TEXT, thumbnail_url TEXT, speaker TEXT,
    type TEXT DEFAULT 'live', playlist_id TEXT, current_sermon_id TEXT, current_sermon_offset_seconds INTEGER DEFAULT 0,
  ...
  `CREATE TABLE IF NOT EXISTS playlists (
    id TEXT PRIMARY KEY, title TEXT NOT NULL, description TEXT,
    repeat_mode TEXT DEFAULT 'none', shuffle BOOLEAN DEFAULT FALSE,
  ...
  `CREATE TABLE IF NOT EXISTS playlist_items (
    ...
    content_id TEXT NOT NULL, order_index INTEGER NOT NULL DEFAULT 0,
    duration_minutes INTEGER NOT NULL DEFAULT 30, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
  )`,
  ...
  `CREATE TABLE IF NOT EXISTS radio_state (
    id TEXT PRIMARY KEY DEFAULT 'singleton', schedule_id TEXT,
    current_item_id TEXT, offset_seconds INTEGER DEFAULT 0,
