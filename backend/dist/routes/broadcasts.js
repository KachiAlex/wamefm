...
router.post('/', async (req, res) => {
    ...
    await db.run('INSERT INTO broadcasts (id, title, description, scripture_reference, status, started_at, broadcaster_id, church_online_url) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)', [id, title, description || '', scripture_reference || '', 'live', new Date().toISOString(), 'anonymous', church_online_url || null]);
